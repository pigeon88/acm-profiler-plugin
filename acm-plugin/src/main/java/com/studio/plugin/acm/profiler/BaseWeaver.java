...
public abstract class BaseWeaver implements IWeaver {
    ...
    public final void weaveJar(File inputJar, File outputJar) throws IOException {
        ...
        while (inEntries.hasMoreElements()) {
            ...
            if (!isWeavableClass(outEntry.getName())) {
    ...
    public boolean isWeavableClass(String fullQualifiedClassName) {
        ...
        return fullQualifiedClassName.endsWith(".class") &&
                !(fullQualifiedClassName.matches("\\S+?/R(\\$\\w+)?\\.class")
                        || fullQualifiedClassName.endsWith("/BuildConfig.class")
                        || fullQualifiedClassName.startsWith("android/support/")
                        || fullQualifiedClassName.startsWith("com/studio/plugin/"));
    }
